...
fsutil_cat (char **argv)
{
  ...
  /* Call our create file function instead of the file sys create call to check the inode type*/
  ...
  for (;;)
    {
      ...
      if (type == USTAR_EOF)
      ...
      else if (type == USTAR_REGULAR)
        {
		  ...
		  /* Add the boolean indicating is_dir or not, false if inode is file */
